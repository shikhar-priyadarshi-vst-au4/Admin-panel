...
function SuccessAlert({showModal = false, setShowModal = () => {}}) {
  return (
    <>
      {showModal ? (
        <>
              ...
              <div className="border-0 rounded-md shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="relative rounded-md p-5 pb-0 flex-auto bg-white">
                  <p className="my-4 h-28  text-lg leading-relaxed grid grid-cols-1 place-items-center">
                        ...
                        <div className="text-gray-800 font-mulish uppercase text-base  text-center">Successfully Done</div>
                  </p>
                </div>
                <div className="flex items-center justify-center p-2 rounded-b   cursor-pointer ">
                  <button
                    className="bg-green-100 text-green-500 background-transparent  font-bold tracking-wider uppercase px-12 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
